...
<html lang="en">
    ...
    <div id="layoutSidenav_content">
        ...
        <div class="container-fluid px-4">
                <h1 class="my-4 text-center">Tambah Stock Roti</h1>
                <div class="col-md-8 m-auto card p-5 shadow -3 mb-5 bg-body rounded">
                        <form enctype="multipart/form-data" action="../proses/tambahstock_roti.php" method="post">					
                           <div class="mb-3">
                             <label for="exampleFormControlInput1" class="form-label">ID Stock</label>
                               <input name="id_stock" type="text" class="form-control id=exampleFormControlInput1">
                            </div>
                            <div class="mb-3">
                                ...
                                <select name="id_roti" class="form-control" id="exampleFormControlSelect1">
                                    ...
                                    while ($row_roti = mysqli_fetch_assoc($result_roti)) {
                                        ...
                                        echo "<option value=\"$id_roti\">$id_roti</option>";
                                    }
                                    ?>
                                </select>
                            </div>
