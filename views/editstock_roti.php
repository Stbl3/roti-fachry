...
<html lang="en">
        ...
        <nav class="sb-sidenav accordion sb-sidenav-secondary bg-danger" id="sidenavAccordion">
            <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link active text-black" href="./stock_roti.php">
    ...
    <div id="layoutSidenav_content">
        ...
        <?php
            include '../config/koneksi.php';
            $id = $_GET['id'];
            $query = "SELECT * FROM stock_roti WHERE id = '$id'";
            $result = mysqli_query($koneksi, $query);
            $data = mysqli_fetch_assoc($result);
        ?>
        <div class="container-fluid px-4">
                <h1 class="my-4 text-center">Edit Stock Roti</h1>
                <div class="col-md-8 m-auto card p-5 shadow -3 mb-5 bg-body rounded">
                        <form enctype="multipart/form-data" action="../proses/editstock_roti.php" method="post">	
                            <input type="hidden" name="id" value="<?= $id ?>">				
                           <div class="mb-3">
                             <label for="exampleFormControlInput1" class="form-label">ID Stock</label>
                               <input name="id_stock" type="text" class="form-control id=exampleFormControlInput1" value="<?= $data['id_stock'] ?>">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="d-flex justify-content-around">
                                ...
                                <a href="./stock_roti.php" class="btn btn-md btn-danger px-5 mt-2">Cancel</a>
                            </div>
                    </form>
                </div> 
            </div>
