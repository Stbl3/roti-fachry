    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                <h1 class="my-4 text-center">Penjualan Roti</h1>
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div id="pagination-container" class="d-flex mb-3">
                            <a href="tambahpenjualan_roti.php" class="btn btn-primary ms-2">Tambah Data</a>
                        </div>
                        <table id="datatablesSimple" class="table">
                            ...
                            <tbody>
                                <?php
                                    $query = "SELECT * FROM penjualan_roti";
                                ...
                                <tr>
                                    ...
                                    <td><?= $data['id_roti'] ?></td>
                                    <td><?= $data['jumlah_roti_terjual'] ?></td>
                                    <td><?= $data['tanggal_penjualan'] ?></td>                                          
                                    <td>
                                        <ul class="list-inline d-flex justify-content-evenly">
                                            <li><a href="./editpenjualan_roti.php?id=<?= $data['id'] ?>" class="btn btn-success">Edit</a></li>
                                            <li>
                                                <form action="../proses/deletepenjualan_roti.php" method="post">
