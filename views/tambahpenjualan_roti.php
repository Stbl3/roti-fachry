...
<html lang="en">
    ...
    <div id="layoutSidenav_content">
        ...
        <div class="container-fluid px-4">
                <h1 class="my-4 text-center">Tambah Penjualan Roti</h1>
                <div class="col-md-8 m-auto card p-5 shadow -3 mb-5 bg-body rounded">
                        <form enctype="multipart/form-data" action="../proses/tambahpenjualan_roti.php" method="post">					
                           <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input name="jumlah_roti_terjual" type="text" class="form-control id=exampleFormControlInput1">
                            </div>
                            <div class="mb-3">
