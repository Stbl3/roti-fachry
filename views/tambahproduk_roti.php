    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                <h1 class="my-4 text-center">Tambah Produk Roti</h1>
                <div class="col-md-8 m-auto card p-5 shadow -3 mb-5 bg-body rounded">
                        <form enctype="multipart/form-data" action="../proses/tambahproduk_roti.php" method="post">					
                           <div class="mb-3">
                             <label for="exampleFormControlInput1" class="form-label">ID Roti</label>
                               <input name="id_roti" type="text" class="form-control id=exampleFormControlInput1">
                            </div>
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Nama Roti</label>
                                <input name="nama_roti" type="text" class="form-control id=exampleFormControlInput1">
                            </div>
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Kategori Roti</label>
                                <input name="kategori_roti" type="text" class="form-control id=exampleFormControlInput1">
                            </div>
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Harga Roti</label>
                                <input name="harga_roti" type="text" class="form-control id=exampleFormControlInput1">
                            </div>
