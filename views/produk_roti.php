    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                <h1 class="my-4 text-center">Produk Roti</h1>
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div id="pagination-container" class="d-flex mb-3">
                            <a href="tambahproduk_roti.php" class="btn btn-primary ms-2">Tambah Data</a>
                        </div>
                        <table id="datatablesSimple" class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?= $data['kategori_roti'] ?></td>
                                    <td><?= $data['harga_roti'] ?></td>                                          
                                    <td>
                                        <ul class="list-inline d-flex justify-content-evenly">
                                            <li><a href="./editproduk_roti.php?id=<?= $data['id'] ?>" class="btn btn-success">Edit</a></li>
                                            <li>
                                                <form action="../proses/deleteproduk_roti.php" method="post">
